...
rows = pickle.load(open('cs_viz_cache/occlusion_1k.pkl','rb'))
pool = pickle.load(open('cs_viz_cache/pool1000.pkl','rb'))
...
g[['category','n','spatial','featural','pct_spatial']].to_csv('cs_viz_outputs/occlusion_1k_semantic.csv', index=False)
...
plt.tight_layout(); plt.savefig('cs_viz_outputs/occlusion_1k_semantic_table.png', dpi=170, bbox_inches='tight'); plt.close()
print('saved cs_viz_outputs/occlusion_1k_semantic_table.png (+ .csv)')
...
plt.tight_layout(rect=[0,0,1,0.93]); plt.savefig('cs_viz_outputs/occlusion_1k_boundaries.png', dpi=150, bbox_inches='tight'); plt.close()
print('saved cs_viz_outputs/occlusion_1k_boundaries.png')
